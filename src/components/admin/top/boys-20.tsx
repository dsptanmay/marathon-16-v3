...
import { useGetTop20Boys } from "@/hooks/top/use-get-top-20-boys";
import jsPDF from "jspdf";
import autoTable from "jspdf-autotable";
import React from "react";

function Top20BoysButton() {
  const { error, refetch } = useGetTop20Boys();
  ...
  const generatePDF = async (
    ...
    doc.setFontSize(16);
    doc.text("Top 20 Participants - Boys", pageWidth / 2, 20, {
      align: "center",
    });
    autoTable(doc, {
...
export default Top20BoysButton;
